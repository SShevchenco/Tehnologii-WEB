...
<head>
    <title>LAB</title>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="CSS/11STATUIAZEUS.css" />
...
<div id="outer">
    <div id="hdr">
        <h1>Statuia lui Zeus din Olympia</h1>
    </div>
    <div id="cont">
        <video controls class="vid">
            <source src="VIDEO/Zeus Statue at Olympia.mp4">
        </video>
        <h2>Informatie </h2>
        <p>
            ...
            In 1958 a fost descoperit la Olympia și atelierul lui Phidias unde s-a lucrat la realizarea statuii și au putut fi identificate câteva din tehnicile de lucru (ulterior atelierul a fost transformat într-o bazilică creștină, în prezent ruinată).
        </p>
        <img src="FOTO/ZEUS1.jpg" id="rightImg">
        <br>
        <p>
